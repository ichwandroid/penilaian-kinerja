...
<html lang="en">
  <head>
    ...
    <link rel="mask-icon" href="img/icons/safari-pinned-tab.svg" color="#0d5afd">
    <!-- CSS Libraries -->
  ...
  <body>
    ...
    <div class="hero-block-wrapper bg-primary">
      ...
      <div class="custom-container">
        ...
        <!-- Hero Block Content -->
        <div class="hero-block-content"><img class="mb-4" src="img/core-img/logo-anaksaleh.png" alt="">
          <h2 class="display-4 text-white mb-3">Selamat Datang di Aplikasi Rapor Kinerja</h2>
          <p class="text-white">Aplikasi Rapor Kinerja Gukar Anak Saleh</p><a class="btn btn-warning btn-lg w-100" href="page-login.php">Mulai</a>
        </div>
      </div>
    </div>

...
<div class="page-content-wrapper py-3">
	<div class="container">
		...
		<div class="element-heading">
			<h6>File Upload Ijasah SD / MIN</h6>
		</div>
	</div>
	<div class="container">
        <div class="card">
          <div class="card-body">
            <div class="file-upload-card">
              ...
              <h5 class="mt-2 mb-4">Upload Ijasah SD / MIN Anda</h5>
              <form action="action/act_editsd.php" method="POST" enctype="multipart/form-data">
                <div class="form-file">
